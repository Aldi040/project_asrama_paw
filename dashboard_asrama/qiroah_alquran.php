  ...
  <div class="flex">
   ...
   <div class="bg-gray-900 text-white w-64 min-h-screen">
    ...
    <nav class="mt-6">
     ...
     <div class="px-6 py-2 text-gray-200 bg-gray-800 cursor-pointer" id="ekstrakulikulerMenuButton" herf="ekstrakulikuler.php">
   ...
   <div class="flex-1 p-6">
    ...
    <!-- Cards for other menus -->
     <!-- konten -->
      <div>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea architecto ab quos excepturi ut sunt doloribus non necessitatibus eius! Quia similique atque in vel neque quasi esse. Sequi, impedit est.</p>
      </div>
   </div>
  </div>
  <script>
